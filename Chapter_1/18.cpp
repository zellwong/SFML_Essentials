...
void setupShape(sf::RectangleShape& shape, sf::Vector2f const& pos,
...
int main() {
  ...
  while (window.isOpen()) {
    ...
    // Always moving right
    playerRect.move(1, 0);
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Down)) playerRect.move(0, 1);
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Up)) playerRect.move(0, -1);
